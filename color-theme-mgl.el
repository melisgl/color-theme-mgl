...
(defun color-theme-mgl (theme-name)
  (custom-theme-set-faces
   ...
   `(lazy-highlight ((t (:inherit default :background ,background-high-1))))
   ;; font-lock
   ...
   ;; outline
   `(outline-1 ((t (:foreground ,foreground-low-1))))
   `(outline-2 ((t (:foreground ,foreground-low-2))))
   `(outline-3 ((t (:foreground ,foreground-low-3))))
   `(outline-4 ((t (:foreground ,2nd-foreground))))
   `(outline-5 ((t (:foreground ,2nd-foreground-low-1))))
